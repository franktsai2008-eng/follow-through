...
## 1. 做什麼、不做什麼
- 做：交易「之後」跨公司的來回。今天主角是談價十組；催款五組已跑完，只放 I03 當「不只談判」的一張截圖，不做分頁。I03：買方要 3% 折扣換今天付，賣方權限只有 2%，最後 $9,212 當天電匯、2%，兩邊紀錄一致，賣方全程講明 2% 是上限。其餘四組：兩組買方要的付款日超過賣方 15 天權限，賣方標「要主管批」不硬答應（I01、I05）；一組爭議款買方走人但兩邊紀錄一致寫「$5,300 先付、非全額和解」（I02）；一組拖延型買方拿不到日期（I04）。催款的計分器還沒改（它問的是有沒有成交訂單），所以數字表不放催款，只放逐字稿。
